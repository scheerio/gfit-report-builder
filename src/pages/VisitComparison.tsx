  ...
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.row}>
        ...
        {visits.map((visit, i) => (
          <Text key={i} style={i === 0 ? styles.value1 : styles.value2}>{visit.frt}</Text>
        ))}
      </View>
      ...
      <View style={styles.row}>
        ...
        {visits.map((visit, i) => (
          <Text key={i} style={i === 0 ? styles.value1 : styles.value2}>{visit.ols.right}</Text>
        ))}
      </View>
      ...
      <View style={styles.row}>
        ...
        {visits.map((visit, i) => (
          <Text key={i} style={i === 0 ? styles.value1 : styles.value2}>{visit.ols.left}</Text>
        ))}
      </View>
      ...
      <View style={styles.row}>
        ...
        {visits.map((visit, i) => (
          <Text key={i} style={i === 0 ? styles.value1 : styles.value2}>{visit.srt}</Text>
        ))}
      </View>
      ...
      <View style={styles.row}>
        ...
        {visits.map((visit, i) => (
          <Text key={i} style={i === 0 ? styles.value1 : styles.value2}>{visit.pst.ap}</Text>
        ))}
      </View>
      ...
      <View style={styles.row}>
        ...
        {visits.map((visit, i) => (
          <Text key={i} style={i === 0 ? styles.value1 : styles.value2}>{visit.pst.ml}</Text>
        ))}
      </View>
      ...
      {visits.map((visit, i) => (
        <View key={i} style={styles.row}>
          ...
          <Text style={i === 0 ? styles.value1 : styles.value2}>{visit.comments}</Text>
        </View>
      ))}
    </Page>
  </Document>
          ...
          <div className="bg-white shadow overflow-hidden sm:rounded-lg mb-6">
            <div className="px-4 py-5 sm:p-6">
              <div className="grid grid-cols-3 gap-4">
                ...
                {visits.map((visit, i) => (
                  <div key={i} className="text-gray-900">{visit.frt}</div>
                ))}

                <div className="font-medium text-gray-500">OLS Right</div>
                {visits.map((visit, i) => (
                  <div key={i} className="text-gray-900">{visit.ols.right}</div>
                ))}

                <div className="font-medium text-gray-500">OLS Left</div>
                {visits.map((visit, i) => (
                  <div key={i} className="text-gray-900">{visit.ols.left}</div>
                ))}

                <div className="font-medium text-gray-500">SRT Score</div>
                {visits.map((visit, i) => (
                  <div key={i} className="text-gray-900">{visit.srt}</div>
                ))}

                <div className="font-medium text-gray-500">PST AP</div>
                {visits.map((visit, i) => (
                  <div key={i} className="text-gray-900">{visit.pst.ap}</div>
                ))}

                <div className="font-medium text-gray-500">PST ML</div>
                {visits.map((visit, i) => (
                  <div key={i} className="text-gray-900">{visit.pst.ml}</div>
                ))}

                <div className="font-medium text-gray-500">Comments</div>
                {visits.map((visit, i) => (
                  <div key={i} className="text-gray-900">{visit.comments}</div>
                ))}
              </div>
            </div>
          </div>
